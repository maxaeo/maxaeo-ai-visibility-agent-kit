...
|---|---|---|---|---|
| 2026-06-29 | `maxaeo/maxaeo-ai-visibility-mcp` | prepared | https://github.com/maxaeo/maxaeo-ai-visibility-mcp/commit/1371f3b2079ec8260c61158506ab793646964103 | Prepared `0.3.1` release with synchronized package/tool/server README versions. Tests and GitHub Actions passed. npm publish is pending local npm login. |
